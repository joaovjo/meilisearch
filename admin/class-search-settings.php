		...
		<div class="wrap">
			...
			if (isset($_GET['updated'])): ?>
				<div class="notice notice-success is-dismissible">
					<p><?php esc_html_e(
						'Search settings saved successfully. Remember to reindex your content for changes to take effect.',
						'meilisearch',
					); ?></p>
				</div>
			<?php endif; ?>
			...
			<p class="description">
				<?php esc_html_e(
					'Configure which attributes can be used for filtering and sorting search results. These settings apply to all sites in the network.',
					'meilisearch',
				); ?>
			</p>
			...
			<form method="post" action="<?php echo esc_url(network_admin_url('edit.php?action=meilisearch_search_settings')); ?>">
				...
				<p class="description">
					<?php esc_html_e(
						'Select which attributes can be used to sort search results. For example, you can sort by publication date (descending) to show newest content first.',
						'meilisearch',
					); ?>
				</p>
				...
				<p class="description">
					<?php esc_html_e(
						'Select which attributes can be used to filter search results. For example, you can filter by post type, author, categories, or tags.',
						'meilisearch',
					); ?>
				</p>
				...
				<table class="form-table">
					<tr>
						...
						<td>
							...
							<p class="description">
								<?php esc_html_e(
									'Display colored badges showing the relevance percentage next to search result titles. You can customize the badge styles in your theme CSS.',
									'meilisearch',
								); ?>
							</p>
						</td>
					...
					<tr>
						...
						<td>
							...
							<p class="description">
								<?php esc_html_e(
									'Display the full permalink URL after each search result content. You can customize the URL display styles in your theme CSS.',
									'meilisearch',
								); ?>
							</p>
						</td>
				...
				<p class="description">
					...
					printf(
						...
						esc_html__(
							'Configure the order and priority of ranking rules that determine search results relevancy. Learn more about %1$s and %2$s.',
							'meilisearch',
						),
						'<a href="https://www.meilisearch.com/docs/learn/relevancy/ranking_rules" target="_blank">'
						. esc_html__('ranking rules', 'meilisearch')
						. '</a>',
						'<a href="https://www.meilisearch.com/docs/learn/relevancy/custom_ranking_rules" target="_blank">'
						. esc_html__('custom ranking rules', 'meilisearch')
						. '</a>',
					);
					?>
				</p>
				...
				<p class="description">
					<?php esc_html_e(
						'Drag and drop to reorder the built-in ranking rules. Higher rules have more priority in determining search relevancy.',
						'meilisearch',
					); ?>
				</p>
				...
				<p class="description">
					<?php esc_html_e(
						'Add custom ranking rules to promote certain documents. Format: attribute_name:asc or attribute_name:desc',
						'meilisearch',
					); ?>
				</p>
					...
					<ul id="custom-rules-list" class="custom-rules-list">
						...
						if (!empty($custom_rules)):
							...
							<li class="custom-rule-item" data-rule="<?php echo esc_attr($custom_rule); ?>">
								...
								<input type="hidden" name="meilisearch_search_settings[custom_ranking_rules][]" value="<?php echo
									esc_attr($custom_rule)
								; ?>" />
							</li>
						<?php endif;
							endforeach;
				...
				<table class="form-table">
					...
					<tr>
						...
						<td>
							...
							<p class="description">
								<?php esc_html_e(
									'For date fields like "date" or "modified", descending order shows newest content first.',
									'meilisearch',
								); ?>
							</p>
						</td>
				...
				<div class="notice notice-info inline">
					<p>
						...
						<?php esc_html_e(
							'After changing these settings, you need to reindex your content for the changes to take effect. Use WP-CLI:',
							'meilisearch',
						); ?>
