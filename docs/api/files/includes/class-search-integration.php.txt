...
class Meilisearch_Search_Integration
{
	...
	public function add_url_after_excerpt(string $excerpt): string
	{
		...
		$permalink = 'attachment' === $post_type ? wp_get_attachment_url(get_the_ID()) : get_permalink();
		...
		$url_display =
			'<div class="meilisearch-result-url" style="margin-top:0.5rem;font-size:0.85rem;color:#666;word-break:break-all;">'
