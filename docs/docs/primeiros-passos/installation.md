...
4. 🔍 Configure [Multi-Pattern Search](../features/multi-pattern-search.md) se tiver múltiplas redes
...
Veja o [Guia de Troubleshooting](../topicos-avancados/troubleshooting.md) completo para mais problemas e soluções.
